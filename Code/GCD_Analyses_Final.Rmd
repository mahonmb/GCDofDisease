...
##12.06 is due to between study variation; 87.81 is due to within study variation
...
##10.59 is due to between study variation; 89.27 is due to within study variation
...
ggplot(figdat_sub, aes(x = GCD_xlab, 
    ...
    geom_hline(yintercept = 0,                   #make a reference line at 0
             ...
             color = "black", 
             size = 1) +
  geom_vline(xintercept = c(3.5,6.5,11.5,19.5),
             color = "grey",
             linetype = "dotted",
             linewidth = 1)+
...
```{r, echo = F, eval = F}
EDF10_WHOLE = cowplot::align_plots(endpointfig+theme(legend.position = c(0.775,0.325),
...
##Replicates for climate change (310)
nrow(dataCC2)
...
##Replicates for chemical pollution (336)
nrow(dataCP2)
```
...
chempollimport$Variable = c("Vector-borne",
                            "Free living stages",
                            "Habitat",
                            "Host type",
                            "Host thermy",
